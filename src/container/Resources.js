        ...
        <div className="container-fluid">
          ...
          <Row classname="container">
            <div className="resources">
              <h4 align="center">What is a Vegan?</h4>
              ...
              <h4 align="center">Why Veganism?</h4>
              ...
              <h4 align="center">  Vegan Nutrition</h4>
          ...
          <Row className="photo">
            <Col />
            <div ><img align="center" src={Vegan} alt="boohoo" className="img-responsive" /></div>;
              <Col />
          </Row>
          <h3 className="photo" align="center">Sources</h3>
          <Row className="photo">
            <Col />
            <ul>
